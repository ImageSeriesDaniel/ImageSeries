...
SIZE = [227,227]  #Size of the canvas
...
TRANSLATIONLENGTH = (1110,1120)      #Length of the vector for the objects to move (min,max) in pixel
DEFLECTIONBORDERLENGTH = 120     #This value is divided by two in the further code. 
BGMAXTRANSLATION = (8,8)        #Maximum Translation of the background in a whole series
...
class ImageSeries():
    ...
    def getBackground(self, bgFile=None, left=None, top=None):
        ...
        return MoveableObject(img=bgImg, filename = bgFile[1], pos=[-BGMAXTRANSLATION[0]+int(bgImg.size[0]/2.), -BGMAXTRANSLATION[1]+int(bgImg.size[1]/2.)], scale=1., rotation=0., cvSize=self.size) ,[left,top]       
